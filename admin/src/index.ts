...
<body>
  ...
  <div class="overlay" id="overlay" aria-hidden="true"><aside class="panel" role="dialog" aria-modal="true" aria-labelledby="panel-title"><div class="panel-head"><div><div class="eyebrow">Fiche commerçant</div><h2 id="panel-title">Commerce</h2><div class="muted" id="panel-email"></div></div><button class="close" id="close-panel" type="button" aria-label="Fermer">×</button></div><div id="panel-content"></div></aside></div>
