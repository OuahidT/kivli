      ...
      <section className="join-card">
        ...
        <div className="join-form-wrap">
          ...
          <form onSubmit={submit} className="form-grid">
            ...
            <label className="consent-check join-sms-consent">
              <input name="marketingConsent" type="checkbox" />
              <span className="join-sms-consent-copy">
                <span>J’accepte que {program.businessName} m’envoie ses offres par SMS. Je pourrai retirer mon accord depuis ma carte.</span>
                <em>Facultatif</em>
              </span>
            </label>
